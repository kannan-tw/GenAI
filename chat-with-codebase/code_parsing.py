            ...
            if any(file.endswith(ext) for ext in allowed_extensions):
                ...
                if "files" in include_levels:
                    ...
                    output_data.append({
                        ...
                        #"code_summary" : generate_code_summary(inline_code,summary_flag)
                    })
                    output_data.append({
                        "type": "file_code",
                        "name": "code-" + file,
                ...
                if "functions" in include_levels:
                    for func in code_entities["functions"]:
                        ...
                        output_data.append({
                            ...
                            #"code_summary" : generate_code_summary(func["code"],summary_flag)
                        })
                        output_data.append({
                        "type": "function_code",
                        "name": "code-" + func["name"],
                        ...
                        "code": func["code"],  # Include inline code directly under file
                        #"code_summary" : file_summary
                        })
                        output_data.append({
                        "type": "summary",
...
def generate_code_summary(source_code,summary_flag):
    ...
    response = client.chat.completions.create(
        model= model_name, #'gpt-4o-mini',#llmconfig.model_name,  # Use the desired model
        messages=messages,
        #temperature=0.5
    )
